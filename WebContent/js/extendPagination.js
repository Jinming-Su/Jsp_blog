(function($){
    $.fn.extendPagination = function(options, targetHerf){
        ...
        function pushPagination(targetObj, beginNumber, endNumber){
            ...
            html.push('<li class="hidden"><a href="' + targetHerf + 1 + '.do' + '">First</a></li>');
            html.push('<li class="previous"><a href="' + targetHerf + previousNumber + '.do' +  '">&laquo;</a></li>');
            html.push('<li class="disabled hidden"><a href="#">...</a></li>');
            for (var i = beginNumber; i <= endNumber; i++){
                if( i == pageNumber){
                    html.push('<li class="active"><a href="' + targetHerf + i + '.do' + '">' + i + '</a></li>');
                }else{
                    html.push('<li><a href="' + targetHerf + i + '.do' +  '">' + i + '</a></li>');
                }
            }
            html.push('<li class="disabled hidden"><a href="#">...</a></li>');
            html.push('<li class="next"><a href="' + targetHerf + nextNumber + '.do' +  '">&raquo;</a></li>');
            html.push('<li class="hidden"><a href="' + targetHerf + totalPage + '.do' +  '">Last</a></li>');
        ...
        appointObj.click(function(){
            ...
            if(appointNumber <= totalPage && appointNumber > 0 && appointNumber != pageNumber){
                window.location.href = targetHerf + appointNumber+'.do';
            }else{
                return false;
            }       
        });
